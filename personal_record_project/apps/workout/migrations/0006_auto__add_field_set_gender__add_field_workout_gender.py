...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.gender'
        db.add_column(u'workout_set', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='male', max_length=6),
                      keep_default=False)

        # Adding field 'Workout.gender'
        db.add_column(u'workout_workout', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='male', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.gender'
        db.delete_column(u'workout_set', 'gender')

        # Deleting field 'Workout.gender'
        db.delete_column(u'workout_workout', 'gender')
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            'bodyweight': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'workout.set': {
            ...
            'bodyweight': ('django.db.models.fields.IntegerField', [], {}),
