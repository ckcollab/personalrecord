...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workout.bodyweight'
        db.add_column(u'workout_workout', 'bodyweight',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workout.bodyweight'
        db.delete_column(u'workout_workout', 'bodyweight')
