...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'workout_workout', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_profile.UserProfile']))

    def backwards(self, orm):

        # Changing field 'Workout.user'
        db.alter_column(u'workout_workout', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.UserProfile'], null=True))
